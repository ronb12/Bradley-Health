// Bradley Health Navigation Handler
class NavigationHandler {
  ...
  injectNavigation() {
    ...
    // Insert navigation at the end of the body
    document.body.insertAdjacentHTML('beforeend', navigation);
  }

  setActiveState() {
    const activeNavItem = document.querySelector(`.mobile-nav-item[data-page="${this.currentPage}"]`);
    if (activeNavItem) {
