...
// Create directories
const dirs = ['assets/css', 'assets/icons'];
dirs.forEach(dir => {
...
// Update nav.js
fs.writeFileSync('assets/nav.js', `// Bradley Health Navigation Handler
...
fs.writeFileSync('assets/css/navigation.css', `/* Bradley Health Navigation Styles */
.mobile-header {
  position: sticky;
  top: 0;
...
// Update icon.svg
fs.writeFileSync('assets/icons/icon.svg', `<?xml version="1.0" encoding="UTF-8"?>
